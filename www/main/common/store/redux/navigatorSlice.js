...
export const {
  setCurrentSearchType, setSearchQuery, setInitialVerseId, setVerseHistory,
  setVersesRead, setSearchData, setHomeVerse, setCurrentLanguage,
  setCurrentSource, setCurrentRaag, setCurrentWriter, setActiveShabadId,
  setActiveVerseId, setSearchShabadsCount, setSavedCrossPlatformId, setHistoryOrder,
  setLineNumber, setIsMiscSlide, setMiscSlideText, setIsMiscSlideGurmukhi,
  setIsAnnouncement, setIsRandomShabad, setIsSundarGutkaBani, setSundarGutkaBaniId,
  setCeremonyId, setIsCeremonyBani, setSingleDisplayActiveTab, setShortcuts,
  setMinimizedBySingleDisplay, setIsDontSaveHistory, setFavShabad, setSearchVerse,
  setCurrentMiscPanel, setActivePaneId, setPane1, setPane2,
  setPane3, setDisabledContent, setFilteredBaniOptions,
